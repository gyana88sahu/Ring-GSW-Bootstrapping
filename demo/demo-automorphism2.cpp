...
int main(int argc, char *argv[]){
	...
	{
		cout << "printing cipherMorphed after iteration 0\n\n";
		auto ptxt = RGSWOps<T>::Decrypt(cipherMorphed, kp.secretKey);
		cout << ptxt << "\n";
	}

	cipherMorphed = GetMorphedCiphertext(cipherMorphed, aIdx1);
	...
	cipherMorphed = GetMorphedCiphertext(cipherMorphed, aIdx2);
